...
<template>
  ...
  <div>
    <p class="text-subtitle-1 text-grey-darken-1">
      ...
      prop adds a simple border to one of the 4 sides of the alert. This can be combined props like
      with
      <span class="font-weight-bold">color, dark,</span>
      and
      <span class="font-weight-bold">type</span> to provide unique accents to the alert.
    </p>
    <div class="mt-4">
      ...
      >
      <v-alert border="start" color="info" dark>I'm an alert with a border left type info</v-alert>
    </div>
  </div>
</template>
